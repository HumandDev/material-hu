...
declare const useServerPagination: (placeholder: string | undefined, labelRowsPerPage: '', defaultOrderBy?: string, defaultOrder?: string, limitOptions?: number[], isSurveys?: boolean) => {
    query: string;
    pagination: {
        page: number;
        limit: number;

...
function useSidesheet(DrawerContentComponent, drawerProps, extraProps) {
    ...
    const closeDrawer = () => { var _a; return ((_a = drawerProps === null || drawerProps === void 0 ? void 0 : drawerProps.onClose) === null || _a === void 0 ? void 0 : _a.call(drawerProps)) || setOpen(false); };

...
const useServerPagination = (placeholder = 'PLACEHOLDER', labelRowsPerPage = 'LABEL_ROWS_PER_PAGE', defaultOrderBy = 'CREATED_AT', defaultOrder = 'ASC', limitOptions = [10, 20, 30], isSurveys = false) => {

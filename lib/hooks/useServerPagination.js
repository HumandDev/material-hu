...
defaultOrderBy = 'CREATED_AT', defaultOrder = 'ASC', limitOptions = [10, 20, 30], isSurveys = false) => {
    const form = useForm({
        defaultValues: {
            query: '',
            pagination: {
    ...
    const searchBar = (_jsx(SearchBarController, { control: control, setValue: setValue, isSurveys: isSurveys, placeholder: placeholder }));

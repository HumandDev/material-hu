        ...
        styleOverrides: {
            ...
            outlined: ({ theme }) => {
                ...
                return ({
                    ...
                    '&:hover': {
                        backgroundColor: (_d = theme.palette.base) === null || _d === void 0 ? void 0 : _d.blueBrand[100],
                        borderColor: (_e = theme.palette.base) === null || _e === void 0 ? void 0 : _e.blueBrand[200],
                    },
                    [`&.${buttonClasses.focusVisible}`]: {
                    ...
                    [`&.${buttonClasses.disabled}`]: {
                        ...
                        backgroundColor: (_g = theme.palette.base) === null || _g === void 0 ? void 0 : _g.white,
                        borderColor: (_h = theme.palette.base) === null || _h === void 0 ? void 0 : _h.grey[300],
                    },
                });
            },
            text: ({ theme }) => {

...
export declare const PeopleExperience: {
  ...
  DisplayGroupItem: import('@emotion/styled').StyledComponent<
    import('@mui/system').SystemProps<import('@mui/material').Theme> & {
      ...
      direction?:
        ...
        | undefined;
      spacing?:
        | import('@mui/system').ResponsiveStyleValue<string | number>
        | undefined;
  ...
  ParticipationExpandableItem: ({
    ...
    total,
    slotProps,
  }: import('./components/peopleExperience/Participation').ParticipationExpandableItemProps) => import('react/jsx-runtime').JSX.Element;
  ParticipationItem: ({
    primary,
    secondary,
    partial,
    total,
    slotProps,
  }: import('./components/peopleExperience/Participation').ParticipationItemProps) => import('react/jsx-runtime').JSX.Element;
  ValueIndicator: ({
    value,
    label,
    loading,
    ...
    Omit<
      ...
      > & {
        ref?:
          ...
          | import('react').RefObject<HTMLUListElement>
          | null
          | undefined;
      },
      | 'children'
  ...
  LinearProgressWithLabel: ({
    ...
    value,
    ...other
  }: import('./components/peopleExperience/LinearProgressWithLabel').LinearProgressWithLabelProps) => import('react/jsx-runtime').JSX.Element;
  ActionsMenu: ({
    children,
    renderTrigger,
    closeOnSelect,
  ...
  ActionsMenuItem: ({
    ...
    sx,
    ...props
  }: import('@mui/material').MenuItemProps) => import('react/jsx-runtime').JSX.Element;
  SideTabNavigation: ({
    selectedIndex,
    onChangeIndex,
    tabs,
  ...
  TabPanelItem: ({
    ...
    index,
    ...other
  }: import('./components/peopleExperience/TabPanel').TabPanelItemProps) => import('react/jsx-runtime').JSX.Element;
};

...
export declare const PeopleExperience: {
    ...
    ParticipationExpandableItem: ({ children, primary, secondary, partial, total, noDataMessage, }: import("./components/peopleExperience/Participation").ParticipationExpandableItemProps) => import("react/jsx-runtime").JSX.Element;
    ParticipationItem: ({ primary, secondary, partial, total, noDataMessage, }: import("./components/peopleExperience/Participation").ParticipationItemProps) => import("react/jsx-runtime").JSX.Element;

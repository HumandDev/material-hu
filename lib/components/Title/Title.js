...
const Title = ({ centered = false, copetin = '', copetinTooltip = '', description = '', descriptionTooltip = '', title, variant, sx = {}, }) => {
    return (_jsxs(Stack, { sx: Object.assign({ textAlign: centered ? 'center' : 'left', alignItems: centered ? 'center' : 'flex-start' }, sx), children: [copetin && (_jsxs(Typography, { variant: adjustedCopetin[variant], sx: {

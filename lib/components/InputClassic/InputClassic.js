...
const InputClassic = ({ sx = {}, label, value, helperText, errorText, onChange, placeholder, inputRef, error, maxLength = 100, hasCounter = true, }) => {
    return (_jsxs(FormControl, { sx: sx, error: error, children: [_jsx(CustomLabel, { label: label }), _jsx(CustomInput, { value: value, onChange: onChange, placeholder: placeholder, inputRef: inputRef, maxLength: maxLength }), _jsx(CustomHelperText, { helperText: error ? errorText : helperText, hasCounter: hasCounter, maxLength: maxLength, value: value })] }));
};

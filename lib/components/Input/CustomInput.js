...
const CustomInput = ({ value, onChange, placeholder, inputRef, maxLength, success, multiline = false, startAdornment, sxInput, }) => {
    var _a, _b, _c, _d;
    const { focused, error } = useFormControl() || {};
    const hastEndAdornment = true;
    const theme = useTheme();
    return (_jsx(OutlinedInput, { inputRef: inputRef, inputProps: { maxLength }, multiline: multiline, minRows: 5, startAdornment: startAdornment, endAdornment: hastEndAdornment && (_jsxs(InputAdornment, { sx: {
                alignSelf: multiline ? 'flex-start' : 'center',
            }, position: "end", children: [_jsx(IconX, { size: 20, onMouseDown: e => {
                        onChange === null || onChange === void 0 ? void 0 : onChange('');
                        e.preventDefault();
                    }, style: { cursor: 'pointer' } }), error && (_jsx(IconAlertCircle, { size: 20, color: (_a = theme.palette.textColors) === null || _a === void 0 ? void 0 : _a.errorText })), success && (_jsx(IconCheck, { size: 20, color: (_b = theme.palette.textColors) === null || _b === void 0 ? void 0 : _b.successText }))] })), placeholder: placeholder, value: value, onChange: e => onChange(e.target.value), sx: Object.assign(Object.assign({}, sxInput), { '& fieldset': {

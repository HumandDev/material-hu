...
const CustomInput = ({ value, onChange, placeholder, inputRef, maxLength, success, multiline = false, startAdornment, sxInput, minRows = 5, disabled, }) => {
    ...
    return (_jsx(OutlinedInput, { inputRef: inputRef, inputProps: { maxLength }, multiline: multiline, minRows: minRows, startAdornment: startAdornment, endAdornment: hastEndAdornment && (_jsxs(InputAdornment, { sx: {

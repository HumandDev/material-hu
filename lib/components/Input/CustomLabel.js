...
const CustomLabel = ({ label, success, }) => {
    ...
    const getLabelColor = () => {
        ...
        if (disabled) {
            return (_d = theme.palette.textColors) === null || _d === void 0 ? void 0 : _d.neutralTextDisabled;
        }
        return (_e = theme.palette.textColors) === null || _e === void 0 ? void 0 : _e.neutralText;
    };

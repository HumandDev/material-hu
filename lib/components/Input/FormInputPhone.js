...
const FormInputPhone = props => {
    ...
    return (_jsx(Controller, { render: (_a) => {
            ...
            return (_jsx(InputPhone, Object.assign({}, field, { onChange: (newValue, countryCode) => {
                ...
                }, defaultCountry: defaultCountry, error: !!error, size: size, disabled: disabled, fullWidth: fullWidth, maxRows: maxRows, minRows: minRows, placeholder: placeholder, label: label, autoFocus: autoFocus, "aria-label": ariaLabel, variant: variant, onKeyDown: onKeyDown, onPaste: onPaste, inputProps: inputProps, margin: margin, onClick: onClick, sx: sx, helperText: helperTextProp || showErrors ? error === null || error === void 0 ? void 0 : error.message : undefined, value: valueProp || value })));

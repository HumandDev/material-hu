...
const CustomStepper = ({ steps, stepperProps, setStep }) => (_jsx(Stepper, Object.assign({ connector: _jsx(CustomStepConnector, {}), orientation: 'vertical' }, stepperProps, { children: steps.map((step, index) => (_jsx(Stack, { onClick: () => {
            if (setStep) {
                setStep(index);
                console.log(index);
            }
        ...
        }, sx: { cursor: setStep ? 'pointer' : 'default' }, children: _jsxs(Step, { children: [_jsx(StepLabel, { StepIconComponent: CustomStepIcon, children: step.label }), step.content && _jsx(StepContent, { children: step.content })] }, step.label) }))) })));

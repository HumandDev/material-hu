...
const CustomStepper = ({ steps, stepperProps, onStepClick, activeSubstep }) => (_jsx(Stepper, Object.assign({ connector: _jsx(CustomStepConnector, {}), orientation: "vertical", nonLinear: !!onStepClick }, stepperProps, { children: steps.map((step, index) => (_jsxs(Step, { completed: step.completed, expanded: step.expanded, onClick: () => (onStepClick ? onStepClick(index) : null), sx: { cursor: onStepClick ? 'pointer' : 'default' }, children: [_jsx(StepLabel, { StepIconComponent: CustomStepIcon, children: step.label }), step.content && _jsx(StepContent, { children: step.content }), step.substeps && ((stepperProps === null || stepperProps === void 0 ? void 0 : stepperProps.activeStep) === index) && step.substeps.map((sub, i) => (_jsxs(ListItemButton, { sx: { pl: 1 }, children: [_jsx("p", { style: { visibility: activeSubstep === i ? 'inherit' : 'hidden', fontSize: '16px', marginRight: '42px', color: 'primary' }, children: "\u2022" }), _jsx(Typography, { variant: "body2", color: activeSubstep === i ? 'text.primary' : 'text.secondary', children: sub.label })] }, sub.label)))] }, step.label))) })));

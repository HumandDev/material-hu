...
export const HorizontalStepper = (props) => {
    const { steps, activeStep = 0, disabled = false, onNext = () => null, disabledNext = false, onBack = () => null, disabledBack = false, onFinish = () => null, disabledFinish = false, getStepStateLabel = () => null, getBackLabel = () => null, getNextLabel = () => null, finishLabel = null } = props, stepperProps = __rest(props, ["steps", "activeStep", "disabled", "onNext", "disabledNext", "onBack", "disabledBack", "onFinish", "disabledFinish", "getStepStateLabel", "getBackLabel", "getNextLabel", "finishLabel"]);
    ...
    return (_jsxs(_Fragment, { children: [_jsx(Stack, Object.assign({ component: Stepper, activeStep: activeStep, connector: null, flexDirection: "row", justifyContent: "space-around", alignItems: "center", spacing: 1, p: 3 }, stepperProps, { children: steps.map((step, index) => {
                ...
                }) })), _jsx(Divider, {}), !!currentStep && (currentStep.content({ activeStep, id: currentStep.id })), _jsxs(Stack, { component: Container, maxWidth: "md", flexDirection: "row", py: 2, sx: { backgroundColod: 'background.default' }, children: [!!prevStep && (_jsx(Button, { id: "horizontal-stepper-back-button", onClick: onBack, disabled: disabled || disabledBack, children: getBackLabel(prevStep) })), !!nextStep && (_jsx(Button, { id: "horizontal-stepper-next-button", variant: "contained", onClick: onNext, disabled: disabled || disabledNext, sx: { ml: 'auto' }, children: getNextLabel(nextStep) })), !nextStep && (_jsx(Button, { id: "horizontal-stepper-finish-button", variant: "contained", onClick: onFinish, disabled: disabled || disabledFinish, sx: { ml: 'auto' }, children: finishLabel }))] })] }));
};

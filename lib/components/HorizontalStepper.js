...
export const HorizontalStepper = props => {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs(Stack, { sx: {
                    ...
                    width: '100%',
                        ...
                        }, children: actions }))] }), _jsx(Divider, {}), !!currentStep && currentStep.content({ activeStep, id: currentStep.id }), _jsxs(Stack, { component: Container, maxWidth: "md", flexDirection: "row", py: 2, sx: { backgroundColor: 'background.default' }, children: [!!prevStep && !!backButton && (_jsx(Button, { id: "horizontal-stepper-back-button", onClick: backButton.onClick, disabled: disabled || backButton.disabled, children: (_a = backButton.getLabel) === null || _a === void 0 ? void 0 : _a.call(backButton, prevStep) })), !!nextStep && !!nextButton && (_jsx(Button, { id: "horizontal-stepper-next-button", variant: "primary", onClick: nextButton.onClick, disabled: disabled || nextButton.disabled, sx: { ml: 'auto' }, children: (_b = nextButton.getLabel) === null || _b === void 0 ? void 0 : _b.call(nextButton, nextStep) })), !nextStep && !!finishButton && (_jsx(Button, { id: "horizontal-stepper-finish-button", variant: "primary", onClick: finishButton.onClick, disabled: disabled || finishButton.disabled, sx: { ml: 'auto' }, children: finishButton.label }))] })] }));
};

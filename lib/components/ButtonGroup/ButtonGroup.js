...
const ButtonGroup = ({
  ...
  const noIcon = fixedCheck
    ? _jsx(IconCheck, { size: 16, color: 'none' })
    : null;
  return _jsx(MUIButtonGroup, {
    variant: 'outlined',
    ...
    children: labels.map((label, index) =>
      _jsx(
        Button,
        {
          ...
          sx: {
            backgroundColor:
              selectedButton === index
                ...
                : 'none',
            borderColor:
              base === null || base === void 0 ? void 0 : base.blueBrand[200],
            borderWidth: 1,
            py: 1,
            px: 1.5,
          ...
          startIcon:
            selectedButton === index ? _jsx(IconCheck, { size: 16 }) : noIcon,
          endIcon: noIcon,
          children: label,
        },
        index,

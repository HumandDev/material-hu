...
const TooltipBody = ({ title, description }) => {
    return (_jsxs(Stack, { sx: { p: 1 }, children: [_jsx(Typography, { variant: "globalS", sx: { fontWeight: 'semibold', color: 'white' }, children: title }), _jsx(Typography, { variant: "globalXS", sx: { color: 'white' }, children: description })] }));
};
const Tooltip = (_a) => {

...
const TooltipBody = ({ title, description }) => {
    return (_jsxs(Stack, { sx: { p: 1 }, children: [_jsx(Typography, { variant: "globalS", sx: {
                    color: ({ palette }) => { var _a; return (_a = palette.textColors) === null || _a === void 0 ? void 0 : _a.neutralTextInverted; },
                    fontWeight: 'semiBold',
                }, children: title }), _jsx(Typography, { variant: "globalXS", sx: {
                    color: ({ palette }) => { var _a; return (_a = palette.textColors) === null || _a === void 0 ? void 0 : _a.neutralTextInverted; },
                }, children: description })] }));
};
const Tooltip = (_a) => {
    var { children, disableTooltip = false, delay = 0 } = _a, props = __rest(_a, ["children", "disableTooltip", "delay"]);
    ...
    return (_jsx(MuiTooltip, { arrow: true, placement: direction, sx: {
        ...
        }, title: !disableTooltip ? (_jsx(TooltipBody, { title: title, description: description })) : null, enterNextDelay: delay, children: children }));
};

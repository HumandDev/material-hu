...
const Alert = (props) => {
    ...
    return (_jsxs(AlertMui, { icon: _jsx(data.icon, { color: data.color }), action: _jsxs(Stack, { sx: { flexDirection: 'row', alignItems: 'center' }, children: [action && (_jsx(Button, { variant: "text", onClick: action.onClick, sx: {
                        ...
                        setOpen(false);
                    }, children: _jsx(IconX, { width: "16px", height: "16px" }) }))] }), sx: {
        ...
        }, children: [_jsx(AlertTitle, { sx: { mb: description ? 0.25 : 0 }, children: _jsx(Typography, { variant: "globalS", fontWeight: 'semiBold', children: title }) }), description && _jsx(Typography, { variant: "globalXS", children: description })] }));
};

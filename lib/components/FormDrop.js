...
export const FormDrop = (props) => {
    ...
    return (_jsx(Controller, { name: name, control: control, rules: rules, render: ({ field: { onChange, value } }) => {
            ...
            return (_jsxs(Stack, { spacing: 3, width: "100%", children: [value && (_jsxs(_Fragment, { children: [_jsx(Box, { component: type === FormDropTypes.IMAGE ? "img" : "video", src: value.url || URL.createObjectURL(value.file), alt: altLabel(context), controls: true, sx: {
                                    width: '100%',
                                    height: 'auto',
                                    ...
                                    objectFit: 'cover',
                                    borderRadius: '20px',
                                } }), _jsx(Button, { onClick: handleDelete, sx: { width: 'fit-content' }, children: deleteLabel(context) })] })), !value && (_jsxs(_Fragment, { children: [_jsxs(Box, Object.assign({ "aria-describedby": "drop-picture-error-text", sx: {
                                    borderWidth: '1px',
                                    borderRadius: '20px',

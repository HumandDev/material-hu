...
const Chip = ({ label, size = 'medium', disabled, onDelete, isSelected, onClick, }) => {
    ...
    return (_jsx(MuiChip, { label: _jsx(Typography, { variant: isSmall ? 'globalXXS' : 'globalXS', fontWeight: "fontWeightSemiBold", color: textColor, children: label }), size: size, onDelete: onDelete, onClick: onClick, disabled: disabled, icon: isSelected ? _jsx(IconCheck, { style: iconStyle }) : undefined, sx: {
            borderRadius: 1,
            borderColor: disabled
                ? (_e = theme.palette.border) === null || _e === void 0 ? void 0 : _e.neutralBorder
                : (_f = theme.palette.border) === null || _f === void 0 ? void 0 : _f.primaryBorder,
            borderStyle: 'solid',
            borderWidth: '1px',
            ...
            px: isSmall ? 0.5 : 1,
        }, deleteIcon: _jsx(IconX, { style: iconStyle }) }));
};
export default Chip;

...
export const Menu = ({ id, anchorEl, open, onClose, children, sx, position = 'center', fixedDimensions = true, 'aria-labelledby': labelledby, footer, header, }) => {
    ...
    return (_jsxs(MuiMenu, { id: id, anchorEl: anchorEl, open: open, onClose: onClose, sx: Object.assign({ mt: 1 }, sx), anchorOrigin: anchorOrigin, transformOrigin: transformOrigin, MenuListProps: {
            ...
            paper: {
                ...
                }, children: [header, _jsx(Divider, { sx: { borderBottomWidth: 0.5, color: '#f0f0f0' } })] })), _jsx(Stack, { component: "ul", sx: Object.assign({ flex: 1, px: 0, m: 0 }, (fixedDimensions && fixedDimensionsUlSx)), children: children }), footer && (_jsxs(Stack, { sx: {
                    position: 'sticky',
                    bottom: 0,
                    zIndex: 1,
                    backgroundColor: 'background.paper',
                            ...
                            color: th => { var _a; return (_a = th.palette.border) === null || _a === void 0 ? void 0 : _a.neutralDivider; },
                        } }), _jsx(Stack, { sx: {
                            gap: 1,
                            p: 2,
                            flexDirection: 'row',

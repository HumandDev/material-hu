...
export const Menu = ({ id, anchorEl, open, onClose, children, sx, position = 'center', fixedDimensions = true, 'aria-labelledby': labelledby, footer, }) => {
    ...
    return (_jsxs(MuiMenu, { id: id, anchorEl: anchorEl, open: open, onClose: onClose, sx: Object.assign({ mt: 1 }, sx), anchorOrigin: anchorOrigin, transformOrigin: transformOrigin, MenuListProps: {
        ...
        }, children: [_jsx(Stack, { component: "ul", sx: Object.assign({ px: 0, m: 0, flex: 1 }, (fixedDimensions && fixedDimensionsUlSx)), children: children }), footer && (_jsxs(Stack, { children: [_jsx(Divider, {}), _jsx(Stack, { sx: {
                            gap: 1,
                            p: 2,
                            flexDirection: 'row',

...
const SearchBarController = (props) => {
    ...
    return (_jsx(Box, { sx: { m: isSurveys ? 0 : 1 }, children: _jsx(Controller, { control: control, name: "query", render: ({ field }) => (_jsx(TextField, Object.assign({ fullWidth: true, InputProps: {

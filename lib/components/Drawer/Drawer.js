...
const Drawer = (props) => {
    ...
    return (_jsxs(MuiDrawer, Object.assign({ anchor: "right", open: open, onClose: disableEscapeKeyDown ? undefined : onClose, PaperProps: Object.assign({ sx: Object.assign(Object.assign({ borderRadius: '16px 0 0 16px' }, stylesForSize), PaperProps === null || PaperProps === void 0 ? void 0 : PaperProps.sx) }, PaperProps), sx: Object.assign({ zIndex: 1300 }, sx) }, drawerProps, { children: [_jsxs(Stack, { sx: {
                    ...
                    pl: hasBackButton ? 1 : 3,
                        ...
                        }, children: [hasBackButton && (_jsx(IconButton, { onClick: onClose, sx: { mr: 1 }, children: _jsx(IconArrowLeft, {}) })), _jsx(Typography, { variant: "globalS", sx: { fontWeight: 'semiBold', flex: 1 }, children: title }), _jsx(IconButton, { onClick: onClose, children: _jsx(IconX, {}) })] }), subtitle && (_jsx(Typography, { variant: "globalXS", sx: { fontWeight: 'regular', flex: 1, ml: hasBackButton ? 6 : 0 }, children: subtitle }))] }), withDoubleLayout && (_jsxs(Stack, { sx: { flexDirection: 'row', flexGrow: 1, overflow: 'hidden' }, children: [_jsx(Stack, { sx: {
                            p: 3,
                            overflowY: 'scroll',
                            width: '50%',

...
const AvatarGroup = (_a) => {
    ...
    return (_jsx(AvatarGroupMui, Object.assign({ slotProps: {
        ...
        }, max: MAX_AVATARS, spacing: spacing, renderSurplus: formatSurplus }, props, { sx: Object.assign(Object.assign(Object.assign({}, props.sx), colorsVariant), { height: sizeInPixels, width: sizeInPixels }) })));
};

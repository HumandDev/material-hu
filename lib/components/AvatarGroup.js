...
const AvatarGroup = (_a) => {
    var { size = 'medium', spacing = 'medium', children } = _a, props = __rest(_a, ["size", "spacing", "children"]);
    const theme = useTheme();
    const sizeInPixels = getSizeInPixels(size);
    const colorsVariant = getColorsVariant('default', theme.palette);
    return (_jsx(AvatarGroupMui, Object.assign({}, props, { sx: Object.assign(Object.assign({}, props.sx), { '& .MuiAvatar-root': Object.assign(Object.assign({}, colorsVariant), { height: sizeInPixels, width: sizeInPixels, position: 'static' }) }), slotProps: {
            additionalAvatar: {
                sx: Object.assign({ height: sizeInPixels, width: sizeInPixels }, colorsVariant),
            },
        }, max: MAX_AVATARS, spacing: spacing, renderSurplus: formatSurplus, children: children })));
};

...
const AvatarGroup = (_a) => {
    ...
    return (_jsx(AvatarGroupMui, Object.assign({ sx: Object.assign(Object.assign(Object.assign({}, props.sx), colorsVariant), { height: sizeInPixels, width: sizeInPixels }), slotProps: {
            additionalAvatar: {
                sx: Object.assign({ height: sizeInPixels, width: sizeInPixels }, colorsVariant),
            },
        }, max: MAX_AVATARS, spacing: spacing, renderSurplus: formatSurplus }, props)));
};

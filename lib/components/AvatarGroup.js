...
const AvatarGroup = (_a) => {
    var { size = 'medium', spacing = 'medium', sx = {}, children } = _a, props = __rest(_a, ["size", "spacing", "sx", "children"]);
    const theme = useTheme();
    const sizeInPixels = getSizeInPixels(size);
    const colorsVariant = getColorsVariant('default', theme.palette);
    return (_jsx(AvatarGroupMui, Object.assign({ sx: Object.assign(Object.assign(Object.assign({}, sx), colorsVariant), { height: sizeInPixels, width: sizeInPixels, position: 'static' }), slotProps: {
            additionalAvatar: {
                sx: Object.assign({ height: sizeInPixels, width: sizeInPixels }, colorsVariant),
            },
        }, max: MAX_AVATARS, spacing: spacing, renderSurplus: formatSurplus }, props, { children: children })));
};

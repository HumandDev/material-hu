...
import { IconChevronRight as ChevronRightIcon, IconDotsVertical as MoreVertIcon, } from '@tabler/icons-react';
export const IconsMenu = props => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(IconButton, Object.assign({ "aria-label": "menu", "aria-controls": "icon-menu", "aria-haspopup": "true", "aria-expanded": open ? 'true' : undefined, id: "button-menu", onClick: disabled ? undefined : handleClick, disableRipple: disabled }, iconButtonProps, { children: _jsx(MoreVertIcon, { style: disabled ? disabledStyles : undefined }) })), _jsx(Menu, { id: "icon-menu", anchorEl: anchorEl, open: open, onClose: handleClose, MenuListProps: {

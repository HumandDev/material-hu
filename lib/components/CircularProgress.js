...
const CenteredCircularProgress = (_a) => {
    var { centered = false, dark = false, width = 'medium' } = _a, props = __rest(_a, ["centered", "dark", "width"]);
    const dimension = width === 'small' ? 24 : 32;
    const circularProgress = (_jsx(CircularProgress, Object.assign({ dark: dark, size: dimension }, props)));

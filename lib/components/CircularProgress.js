...
const CenteredCircularProgress = (_a) => {
    var { centered = true, darkBackground = false, width = 'medium' } = _a, props = __rest(_a, ["centered", "darkBackground", "width"]);
    const size = width === 'small' ? 24 : 32;
    const circularProgress = (_jsx(CircularProgress, Object.assign({ sx: Object.assign(Object.assign({}, props.sx), { color: theme => {
                var _a, _b;

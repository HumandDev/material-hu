...
function FormRichEditor(_a) {
    var { editorProps, handleBlur, hideModalButtons, simplifyEditor = false, placeholder, disabled = false, imagesUploadHandler, addVideoEditorPlugin, tinyKey } = _a, props = __rest(_a, ["editorProps", "handleBlur", "hideModalButtons", "simplifyEditor", "placeholder", "disabled", "imagesUploadHandler", "addVideoEditorPlugin", "tinyKey"]);

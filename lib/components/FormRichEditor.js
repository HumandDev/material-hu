...
function FormRichEditor(_a) {
    ...
    return (_jsx(Controller, Object.assign({ render: (_a) => {
            ...
            return (_jsx(Editor, Object.assign({}, field, { onEditorChange: handleEditorChange(onChange), onInit: onInit }, allEditorProps, { apiKey: tinyKey, onBlur: () => (handleBlur ? handleBlur(field.value) : null), disabled: disabled })));
        } }, props)));
}

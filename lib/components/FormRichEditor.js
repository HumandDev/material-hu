...
function FormRichEditor(_a) {
    ...
    const allEditorProps = Object.assign(Object.assign({}, editorProps), { init: Object.assign({ language: i18next.language, menubar: false, height: 500, elementpath: false, contextmenu: false, placeholder, statusbar: !simplifyEditor, resize: !simplifyEditor, max_height: simplifyEditor ? 180 : undefined, plugins: simplifyEditor
                ? 'lists'
    ...
    return (_jsx(Controller, Object.assign({ render: (_a) => {
            ...
            return (_jsx(Editor, Object.assign({}, field, { onEditorChange: handleEditorChange(onChange), onInit: onInit }, allEditorProps, { onBlur: () => (handleBlur ? handleBlur(field.value) : null), disabled: disabled })));
        } }, props)));
}

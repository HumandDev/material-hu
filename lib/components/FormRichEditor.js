...
function FormRichEditor(_a) {
    var { editorProps, handleBlur, hideModalButtons, simplifyEditor = false, placeholder, disabled = false, imagesUploadHandler, addVideoEditorPlugin, tinyKey, fontsURL } = _a, props = __rest(_a, ["editorProps", "handleBlur", "hideModalButtons", "simplifyEditor", "placeholder", "disabled", "imagesUploadHandler", "addVideoEditorPlugin", "tinyKey", "fontsURL"]);
    ...
    return (_jsx(Controller, Object.assign({ render: (_a) => {
            ...
            return (_jsx(Editor, Object.assign({}, field, { onEditorChange: onChange }, allEditorProps, { apiKey: tinyKey, onBlur: () => (handleBlur ? handleBlur(field.value) : null), disabled: disabled })));
        } }, props)));
}

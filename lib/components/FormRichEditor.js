...
function FormRichEditor(_a) {
    var { editorProps, onEditorChange = value => value, onInit = () => null, handleBlur, hideModalButtons, simplifyEditor = false, placeholder, disabled = false, imagesUploadHandler, addVideoEditorPlugin, fontsURL, langsURL } = _a, props = __rest(_a, ["editorProps", "onEditorChange", "onInit", "handleBlur", "hideModalButtons", "simplifyEditor", "placeholder", "disabled", "imagesUploadHandler", "addVideoEditorPlugin", "fontsURL", "langsURL"]);
    const allEditorProps = Object.assign(Object.assign({}, editorProps), { init: Object.assign({ language: i18next.language, language_url: '/tinymce/langs/' + i18next.language + '.js', menubar: false, height: 500, elementpath: false, contextmenu: false, branding: false, placeholder, statusbar: !simplifyEditor, resize: !simplifyEditor, max_height: simplifyEditor ? 180 : undefined, plugins: simplifyEditor
                ? 'lists'

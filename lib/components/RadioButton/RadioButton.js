...
const RadioButton = (_a) => {
    var { error = false, disabled = false, isActive = false, label, extraData, description, stackProps = {}, labelProps = {} } = _a, props = __rest(_a, ["error", "disabled", "isActive", "label", "extraData", "description", "stackProps", "labelProps"]);
    ...
    return (_jsxs(Stack, Object.assign({ sx: { alignItems: 'flex-start', flexDirection: 'row', gap: '4px' } }, stackProps, { children: [_jsx(Radio, Object.assign({}, props, { disabled: disabled, checked: isActive, sx: Object.assign({ padding: 0, color: radioBorderColor }, (hasHoverEffect && {
                    '&:hover': {

...
export const ShowMoreText = props => {
    ...
    const renderText = () => {
        const sx = !show
            ...
            : {};
        return (_jsx(Typography, Object.assign({ ref: textRef }, typographyProps, { sx: Object.assign(Object.assign({}, sx), typographyProps === null || typographyProps === void 0 ? void 0 : typographyProps.sx) }, (isHtmlText ? { __html: text } : { children: formatedText }))));
    };

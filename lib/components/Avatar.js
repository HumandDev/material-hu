...
import { Avatar as AvatarMui, Badge, useTheme, } from '@mui/material';
...
export const getColorsVariant = (color, palette) => {
...
const Avatar = (_a) => {
    var { size = 'medium', color = 'default', withBadge = false, badgeContent, badgeProps = { variant: 'standard', color: 'primary' } } = _a, props = __rest(_a, ["size", "color", "withBadge", "badgeContent", "badgeProps"]);
    ...
    const avatar = (_jsx(AvatarMui, Object.assign({ sx: Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, props.sx), colorsVariant), { '& .MuiAvatar-colorDefault': {
                backgroundColor: "yellow",
                color: "blue",
            }, height: sizeInPixels, width: sizeInPixels }), (props.variant === 'rounded' && {
    ...
    return withBadge ? (_jsx(Badge, Object.assign({}, badgeProps, { overlap: "circular", anchorOrigin: { vertical: 'bottom', horizontal: 'right' }, 
        // On DS3 the standard variant can be used with large and medium size
        variant: isDotVariant ? 'dot' : badgeProps === null || badgeProps === void 0 ? void 0 : badgeProps.variant, badgeContent: badgeContent, children: avatar }))) : (avatar);
};

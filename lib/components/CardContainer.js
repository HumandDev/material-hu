...
const CardContainer = (_a) => {
    ...
    return (_jsxs(Card, Object.assign({ sx: Object.assign({ borderRadius: '16px', width: 328, border: '1px solid #E9E9F4', boxShadow: '-1px 4px 8px 0px #E9E9F4' }, sx) }, props, { children: [_jsx(CardContent, { sx: {
                    p: 2,
                    ':last-child': {
                        pb: 2,
                    },

...
const getFooterActions = (footer) => {
    ...
    if ('action2' in footer) {
        return (_jsxs(_Fragment, { children: [_jsx(Button, Object.assign({}, footer.action2)), _jsx(Button, Object.assign({ variant: "contained" }, footer.action1))] }));
    }
    else {
...
const CardContainer = (_a) => {
    var { badge = undefined, footer = undefined } = _a, props = __rest(_a, ["badge", "footer"]);
    const theme = useTheme();
    const badgeProps = badge ? getBadgeProps(badge.type, theme.palette) : null;
    const footerActions = getFooterActions(footer);
    return (_jsxs(Card, { sx: Object.assign({ borderRadius: '16px', width: 328, border: '1px solid #E9E9F4', boxShadow: '-1px 4px 8px 0px #E9E9F4', my: 2 }, props), children: [_jsxs(CardContent, { children: [_jsx(Typography, { children: "Texto contenido texto contenido" }), _jsx(Typography, { children: "Texto contenido texto contenido" })] }), _jsx(CardActions, { sx: {
                    ...
                    border: `1px solid ${badgeProps.borderColor}`,
                            ...
                            fontSize: 'small',
                            mr: 0.5,
                        } }), _jsx(Typography, { sx: { color: badgeProps.fontColor, fontSize: '12px' } })] }))] }));
};

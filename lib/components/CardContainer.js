...
import { AddBoxOutlined as AddIcon, Check as CheckIcon, ErrorOutline as ErrorIcon, InfoOutlined as InfoIcon, WarningAmberRounded as WarningIcon, } from '@mui/icons-material';
...
const CardContainer = (_a) => {
    ...
    console.error(badgeProps, theme, theme.palette, ((_b = theme.palette.base) === null || _b === void 0 ? void 0 : _b.yellow[100]) || 'null base');

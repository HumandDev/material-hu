...
const getFooterActions = (footer) => {
    ...
    if ('action2' in footer) {
        ...
        return (_jsxs(_Fragment, { children: [_jsx(Typography, { variant: "globalXXS", color: "textSecondary", children: footer.text }), _jsx(Button, Object.assign({ variant: "text" }, footer.action1, { endIcon: _jsx(ChevronRight, { fontSize: "small" }), children: footer.action1.title }))] }));
    }
};
const CardContainer = (_a) => {
    ...
    console.error(props);
    return (_jsxs(Card, { sx: Object.assign({ borderRadius: '16px', width: 328, border: '1px solid #E9E9F4', boxShadow: '-1px 4px 8px 0px #E9E9F4', p: 2 }, props.sx), children: [_jsx(CardContent, { children: children }), footer && (_jsx(CardActions, { sx: {

...
import { IconSquareRoundedPlus as AddIcon, IconCheck as CheckIcon, IconChevronRight as ChevronRight, IconExclamationCircle as ErrorIcon, IconInfoCircle as InfoIcon, IconAlertTriangle as WarningIcon, } from '@tabler/icons-react';
...
const getFooterActions = (footer) => {
    ...
    if ('action2' in footer) {
        ...
        return (_jsxs(_Fragment, { children: [_jsx(Typography, { variant: "globalXXS", color: "textSecondary", children: footer.text }), _jsx(Button // update to new buttons
                , Object.assign({ variant: "text" }, footer.action1, { endIcon: _jsx(ChevronRight, { fontSize: "small" }), children: footer.action1.title }))] }));
    }
};
const CardContainer = (_a) => {
    var { badge = undefined, footer = undefined, children, sx } = _a, props = __rest(_a, ["badge", "footer", "children", "sx"]);
    ...
    return (_jsxs(Card, Object.assign({ sx: Object.assign({ borderRadius: '16px', width: 328, border: '1px solid #E9E9F4', boxShadow: '-1px 4px 8px 0px #E9E9F4' }, sx) }, props, { children: [_jsx(CardContent, { sx: { p: 2 }, children: children }), footer && (_jsx(CardActions, { sx: {

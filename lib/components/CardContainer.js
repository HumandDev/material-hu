...
import { Button } from '..';
import { AddBoxOutlined, Check, ErrorOutline, InfoOutlined, WarningAmberRounded, } from '@mui/icons-material';
...
const getFooterActions = (footer) => {
    ...
    if ('action2' in footer) {
        return (_jsxs(_Fragment, { children: [_jsx(Button, Object.assign({}, footer.action2, { children: footer.action2.title })), _jsx(Button, Object.assign({ variant: "contained" }, footer.action1))] }));
    }
    else {
        return (_jsxs(_Fragment, { children: [_jsx(Typography, { children: footer.text }), _jsx(Button, Object.assign({ variant: "contained" }, footer.action1))] }));
    }
};
const CardContainer = (_a) => {
    ...
    return (_jsxs(Card, { sx: Object.assign({ borderRadius: '16px', width: 328, border: '1px solid #E9E9F4', boxShadow: '-1px 4px 8px 0px #E9E9F4', my: 2 }, props), children: [_jsxs(CardContent, { children: [_jsx(Typography, { children: "Texto contenido texto contenido" }), _jsx(Typography, { children: "Texto contenido texto contenido" }), children] }), footer && (_jsx(CardActions, { sx: {
                    justifyContent: 'space-between',
                    borderTop: '1px solid #E9E9F4',
                    p: '8px 16px 8px 16px',
                }, children: footerActions })), badgeProps && (_jsxs(Box, { sx: {
                    ...
                    border: `1px solid ${badgeProps.borderColor}`,
                            ...
                            fontSize: 'small',
                            mr: 0.5,
                        } }), _jsx(Typography, { sx: { color: badgeProps.fontColor, fontSize: '12px' }, children: badge === null || badge === void 0 ? void 0 : badge.label })] }))] }));
};

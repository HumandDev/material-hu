...
const CardContainer = (_a) => {
    ...
    console.error('sx: ', sx);
    return (_jsxs(Card, { sx: Object.assign({ borderRadius: '16px', width: 328, border: '1px solid #E9E9F4', boxShadow: '-1px 4px 8px 0px #E9E9F4', p: 2 }, sx), children: [_jsx(CardContent, { children: children }), footer && (_jsx(CardActions, { sx: {

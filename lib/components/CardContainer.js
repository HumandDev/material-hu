...
const getFooterActions = (footer) => {
    ...
    if ('action2' in footer) {
        return (_jsxs(_Fragment, { children: [_jsx(Button, Object.assign({}, footer.action2, { children: footer.action2.title })), _jsx(Button, Object.assign({ variant: "primary" }, footer.action1, { children: footer.action1.title }))] }));
    }
    else {
        return (_jsxs(_Fragment, { children: [_jsx(Typography, { variant: "globalXXS", color: "textSecondary", children: footer.text }), _jsx(Button, Object.assign({}, footer.action1, { endIcon: _jsx(ChevronRight, { fontSize: "small" }), children: footer.action1.title }))] }));
    }
};
const CardContainer = (_a) => {
    var { badge = undefined, footer = undefined, hasShadow, children, sx } = _a, props = __rest(_a, ["badge", "footer", "hasShadow", "children", "sx"]);
    ...
    return (_jsxs(Card, Object.assign({ sx: Object.assign({ borderRadius: '16px', width: 328, border: '1px solid #E9E9F4', boxShadow: hasShadow ? '-1px 4px 8px 0px #E9E9F4' : 'none' }, sx) }, props, { children: [_jsx(CardContent, { sx: {
                    p: 2,
                    ':last-child': {
                        pb: 2,
                    },

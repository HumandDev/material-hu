...
const getFooterActions = (footer) => {
    ...
    if ('action2' in footer) {
        ...
        return (_jsxs(_Fragment, { children: [_jsx(Typography, { children: footer.text }), _jsx(Button, Object.assign({ variant: "contained" }, footer.action1, { children: footer.action1.title }))] }));
    }
};

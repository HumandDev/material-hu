...
const SideTabNavigation = ({ selectedIndex, onChangeIndex, tabs, title, layout: Layout = Fragment, sx, }) => {
    const handleListItemClick = (_event, index) => {
        onChangeIndex(index);
    };
    return (_jsxs(Stack, { sx: Object.assign({ flexDirection: 'row', height: '100%' }, sx), children: [_jsxs(Stack, { sx: { gap: 2, py: 4, bgcolor: colors.grey[50], height: '100%' }, children: [_jsx(Typography, { variant: "h5", component: "h2", sx: {

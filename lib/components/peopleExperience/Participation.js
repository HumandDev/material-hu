...
const Misc = ({ total, partial, noDataMessage }) => {
...
export const ParticipationItem = ({ primary, secondary, partial, total, noDataMessage, }) => (_jsxs(ListItem, { children: [_jsx(ListItemText, { primary: primary, secondary: secondary }), _jsx(Misc, { partial: partial, total: total, noDataMessage: noDataMessage })] }));
export const ParticipationExpandableItem = ({ children, primary, secondary, partial, total, noDataMessage, }) => {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs(ListItemButton, { sx: { gap: 2 }, onClick: handleToggle, children: [_jsxs(Stack, { sx: {
                            ...
                            gap: 2,
                            flex: 1,
                        }, children: [_jsx(ListItemText, { primary: primary, secondary: secondary, sx: { flexGrow: 0 } }), expanded ? (_jsx(ExpandLess, { color: "secondary" })) : (_jsx(ExpandMore, { color: "secondary" }))] }), _jsx(Misc, { partial: partial, total: total, noDataMessage: noDataMessage })] }), children(expanded)] }));
};

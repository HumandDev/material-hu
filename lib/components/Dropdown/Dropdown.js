...
const Dropdown = ({ children, label, open, onOpen, onClose, onClick, buttonVariant = 'secondary', position = 'left', buttonSize = 'medium', hasIcon = true, sx = {}, buttonProps = {}, }) => {
    const id = useId();
    ...
    return (_jsxs(Stack, { sx: Object.assign({ flexDirection: 'row', alignItems: 'center', gap: '4px' }, sx), children: [_jsx(Button, Object.assign({ ref: buttonRef, size: buttonSize, "aria-describedby": menuId, variant: buttonVariant, onClick: handleClick, endIcon: hasIcon ? (_jsx(KeyboardArrowDownIcon, { sx: {

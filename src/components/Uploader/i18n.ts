...
initializeCheck(() => {
  i18next.addResources('es', NAMESPACE, {
    ...
    ALLOWED_FORMATS:
      'Formatos permitidos: PDF, JPG o PNG hasta {{fileSizeLimit}}',
  ...
  i18next.addResources('pt', NAMESPACE, {
    ...
    ALLOWED_FORMATS:
      'Formatos permitidos: PDF, JPG ou PNG até {{fileSizeLimit}}',
  ...
  i18next.addResources('de', NAMESPACE, {
    ...
    ALLOWED_FORMATS:
      'Zulässige Formate: PDF, JPG oder PNG bis zu {{fileSizeLimit}}',
